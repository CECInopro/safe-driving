...
//     const selectedAccountId = user?.accountId || "";
...
//         if (autoAssign && !selectedDriverId) {
//             alert("Vui lòng chọn tài xế để tự động gán");
//             return;
//         }

//         if (autoAssign && !selectedAccountId) {
...
//                         </select>
//                         {selectedAccountId && (
//                             <small>Tài khoản: {user?.username} (ID: {selectedAccountId})</small>
//                         )}
//                     </div>
//                 )}
